...
#### 请参阅下面的例子，演示如何使用使用 SpEL 引用一个bean，bean属性也它的方法。
    ...
    public class Customer {
        ...
        @Value("#{addressBean.country}")
        private String country;
        @Value("#{addressBean.getFullAddress('address')}")
...
#### 请参阅在XML文件定义bean的等效版本。
    <beans xmlns="http://www.springframework.org/schema/beans"
        ...
        <bean id="customerBean" class="com.package.Customer">
            ...
            <property name="fullAddress" value="#{addressBean.getFullAddress('address')}" />
        </bean>
        <bean id="addressBean" class="com.package.Address">
